...
function Signup() {
  ...
  return (
    ...
    >
      ...
      <Button variant="outline" className="w-full mt-6 h-11 border-border">
      ...
      >
        <div>
          ...
          <Input id="name" placeholder="Rahul Kumar" className="mt-1.5 h-11" required />
        </div>
        <div>
        ...
        <div>
          ...
          <div className="relative mt-1.5">
            <Input id="password" type={show ? "text" : "password"} className="h-11 pr-10" required />
