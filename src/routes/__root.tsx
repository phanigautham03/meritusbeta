...
import { AuthProvider } from "@/integrations/external-supabase/auth-context";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:site_name", content: "Meritus" },
      { property: "og:image", content: "https://meritus.co.in/og-image.png" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { property: "og:image:alt", content: "Meritus — AI-powered exam prep for JEE, NEET, UPSC and 200+ Indian exams" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@MeritusApp" },
