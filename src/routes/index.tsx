...
const features = [
  { icon: Brain, color: "teal", title: "Forget-Meter AI", desc: "Ebbinghaus forgetting curve tracks exactly when you'll forget each topic." },
  { icon: Monitor, color: "primary", title: "NTA Exam Simulator", desc: "Pixel-perfect replica of the actual JEE/NEET interface with real-time timer." },
  { icon: Sparkles, color: "gold", title: "ExamMatch AI", desc: "Claude AI analyses your profile and recommends the best-fit exams for you." },
  { icon: CalendarDays, color: "purple", title: "AI Study Planner", desc: "Personalised week-by-week study schedule generated by AI." },
  { icon: TrendingUp, color: "success", title: "Rank Predictor", desc: "Know your expected rank before the result." },
  { icon: Users, color: "blue", title: "Mentor Connect", desc: "1-on-1 sessions with toppers who cracked your target exam." },
];
